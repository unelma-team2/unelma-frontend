        ...
        {featured && (
          ...
          >
            ...
            >
              ...
              <h2 style={{ fontWeight: 700, fontSize: "1.5rem", margin: "0 0 1rem 0" }}>
                {featured.Title || "Blog Title"}
              </h2>
              <p style={{ color: "#2F2E2E", marginBottom: "1.5rem" }}>
                {featured.Description
                  ? featured.Description.slice(0, 900) + "..."
                  : ""}
              </p>
              <div style={{ marginTop: "auto", textAlign: "right" }}>
                <Link href={`/blog/${featured.slug}`} style={{ color: "#9D00A0", fontWeight: 600 }}>
                  Read more →
                </Link>
              </div>
            </div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div style={{ marginTop: "auto", textAlign: "right" }}>
                    <Link href={`/blog/${blog.slug}`} style={{ color: "#9D00A0", fontWeight: 600 }}>
                      Read more →
                    </Link>
                  </div>
                </div>
